...
{
model->ab=1.0;
EXIT_IF_ISNAN(model->ab)
#if defined(_DERIVATE)
ab_Vtnode_GND=0.0;
#endif /*_DERIVATE*/
model->aa=1.0;
EXIT_IF_ISNAN(model->aa)
#if defined(_DERIVATE)
aa_Vtnode_GND=0.0;
#endif /*_DERIVATE*/
model->a_eg=(model->vgbe_t0/model->vgbe_t);
EXIT_IF_ISNAN(model->a_eg)
#if defined(_DERIVATE)
a_eg_Vtnode_GND=0.0;
#endif /*_DERIVATE*/
if
...
{
double __sqrt_0=0.0;
_sqrt(__sqrt_0,(model->a_eg))
EXIT_IF_ISNAN(__sqrt_0)
model->ab=(((((model->cjep0_t/model->cjep0)*__sqrt_0)*model->vdep_t)*model->vdep_t)/(model->vdep*model->vdep));
EXIT_IF_ISNAN(model->ab)
#if defined(_DERIVATE)
ab_Vtnode_GND=0.0;
#endif /*_DERIVATE*/
...
{
double __pow_0=0.0;
_pow(__pow_0,model->a_eg,(-1.5))
EXIT_IF_ISNAN(__pow_0)
model->aa=(((model->vdep/model->vdep_t)*(model->cjep0/model->cjep0_t))*__pow_0);
EXIT_IF_ISNAN(model->aa)
#if defined(_DERIVATE)
aa_Vtnode_GND=0.0;
#endif /*_DERIVATE*/
...
_sqrt(__sqrt_0,(model->a_eg))
EXIT_IF_ISNAN(__sqrt_0)
model->ab=(((((model->cjei0_t/model->cjei0)*__sqrt_0)*model->vdei_t)*model->vdei_t)/(model->vdei*model->vdei));
EXIT_IF_ISNAN(model->ab)
#if defined(_DERIVATE)
ab_Vtnode_GND=0.0;
#endif /*_DERIVATE*/
...
_pow(__pow_0,model->a_eg,(-1.5))
EXIT_IF_ISNAN(__pow_0)
model->aa=(((model->vdei/model->vdei_t)*(model->cjei0/model->cjei0_t))*__pow_0);
EXIT_IF_ISNAN(model->aa)
#if defined(_DERIVATE)
aa_Vtnode_GND=0.0;
#endif /*_DERIVATE*/
...
model->ibets_t=(model->ibets*model->ab);
EXIT_IF_ISNAN(model->ibets_t)
#if defined(_DERIVATE)
ibets_t_Vtnode_GND=0.0;
#endif /*_DERIVATE*/
model->abet_t=(model->abet*model->aa);
