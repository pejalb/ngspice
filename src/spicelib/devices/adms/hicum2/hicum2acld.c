...
int hicum2acLoad(GENmodel *inModel, CKTcircuit *ckt)
{
  ...
  if(here->PTR_J_xf_bi_required) *(here->PTR_J_xf_bi)+=here->JSVAL_xf_bi;
  if(here->PTR_J_xf_ei_required) *(here->PTR_J_xf_ei)+=here->JSVAL_xf_ei;
  if(here->PTR_J_xf_ci_required) *(here->PTR_J_xf_ci)+=here->JSVAL_xf_ci;
  if(here->PTR_J_xf_tnode_required) *(here->PTR_J_xf_tnode)+=here->JSVAL_xf_tnode;
  if(here->PTR_J_xf_xf_required) *(here->PTR_J_xf_xf)+=here->JSVAL_xf_xf;
  ...
  if(here->PTR_J_bi_xf_required) *(here->PTR_J_bi_xf+1)+=ckt->CKTomega*here->JDVAL_bi_xf;
  if(here->PTR_J_ei_xf_required) *(here->PTR_J_ei_xf+1)+=ckt->CKTomega*here->JDVAL_ei_xf;
  ...
  if(here->PTR_J_xf_xf_required) *(here->PTR_J_xf_xf+1)+=ckt->CKTomega*here->JDVAL_xf_xf;
