...
#if defined(_DERIVATE)
double edZEB_Vb2_e1;
double edZEB_Vdt_GND;
#endif
double dE0BE;
#if defined(_DERIVATE)
double dE0BE_Vb2_e1;
double dE0BE_Vdt_GND;
#endif
double eZEB;
#if defined(_DERIVATE)
double eZEB_Vdt_GND;
...
double IZEB_T;
#if defined(_DERIVATE)
double IZEB_T_Vdt_GND;
#endif
double nZEB_T;
#if defined(_DERIVATE)
double nZEB_T_Vdt_GND;
#endif
double y;
#if defined(_DERIVATE)
double y_Vdt_GND;
...
#if defined(_DERIVATE)
double CJE_T_div_CJE_Vdt_GND;
#endif
double inv_VDE_T;
#if defined(_DERIVATE)
double inv_VDE_T_Vdt_GND;
#endif
#if defined(_DYNAMIC)
double VDS_T;
#if defined(_DERIVATE)
...
{
double m00_pow(d00_pow0,2.0,(2.0-pModel->PE))
pow2_2mPE=d00_pow0;
EXIT_IF_ISNAN(d00_pow0)
}
pow2_PEm2=(1.0/pow2_2mPE);
EXIT_IF_ISNAN((1.0/pow2_2mPE))
Trk=(pModel->TREF+273.15);
EXIT_IF_ISNAN((pModel->TREF+273.15))
_x=(pModel->VGZEB+(((pModel->AVGEB*Trk)*Trk)/(Trk+pModel->TVGEB)));
EXIT_IF_ISNAN((pModel->VGZEB+(((pModel->AVGEB*Trk)*Trk)/(Trk+pModel->TVGEB))))
_x0=0.05;
EXIT_IF_ISNAN(0.05)
_a=0.1;
EXIT_IF_ISNAN(0.1)
_dxa=((_x-_x0)/_a);
EXIT_IF_ISNAN(((_x-_x0)/_a))
if
((_x<_x0))
{
{
double m00_exp(d00_exp0,_dxa)
double m00_logE(d00_logE1,(1.0+d00_exp0))
VGZEBOK=(_x0+(_a*d00_logE1));
EXIT_IF_ISNAN((_x0+(_a*d00_logE1)))
}
}
else
{
...
double m00_exp(d00_exp0,(-_dxa))
double m00_logE(d00_logE1,(1.0+d00_exp0))
VGZEBOK=(_x+(_a*d00_logE1));
EXIT_IF_ISNAN((_x+(_a*d00_logE1)))
}
}
VGZEB_Tr=pModel->VGZEB;
EXIT_IF_ISNAN(pModel->VGZEB)
inv_VGZEB_Tr=(1.0/VGZEB_Tr);
EXIT_IF_ISNAN((1.0/VGZEB_Tr))
inv_VDE=(1.0/pModel->VDE);
EXIT_IF_ISNAN((1.0/pModel->VDE))
...
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
lntN_Vdt_GND=tN_Vdt_GND*d10_logE0;
#endif
lntN=d00_logE0;
EXIT_IF_ISNAN(d00_logE0)
}
...
dxa_Vb2_c1=0.0;
dxa_Vc1_c2=0.0;
dxa_Vdt_GND=((-(((((pModel->AVGEB*Tk_Vdt_GND)*pInst->Tk)+((pModel->AVGEB*pInst->Tk)*Tk_Vdt_GND))*(pInst->Tk+pModel->TVGEB)-((pModel->AVGEB*pInst->Tk)*pInst->Tk)*Tk_Vdt_GND)/(pInst->Tk+pModel->TVGEB)/(pInst->Tk+pModel->TVGEB)))/0.1);
#endif
dxa=(((VGZEBOK-(((pModel->AVGEB*pInst->Tk)*pInst->Tk)/(pInst->Tk+pModel->TVGEB)))-0.05)/0.1);
EXIT_IF_ISNAN((((VGZEBOK-(((pModel->AVGEB*pInst->Tk)*pInst->Tk)/(pInst->Tk+pModel->TVGEB)))-0.05)/0.1))
if
(((VGZEBOK-(((pModel->AVGEB*pInst->Tk)*pInst->Tk)/(pInst->Tk+pModel->TVGEB)))<0.05))
{
{
...
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
VGZEB_T_Vdt_GND=(0.1*dxa_Vdt_GND*d10_exp0*d10_logE1);
#endif
VGZEB_T=(0.05+(0.1*d00_logE1));
EXIT_IF_ISNAN((0.05+(0.1*d00_logE1)))
}
}
else
{
...
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
VGZEB_T_Vdt_GND=((-(((((pModel->AVGEB*Tk_Vdt_GND)*pInst->Tk)+((pModel->AVGEB*pInst->Tk)*Tk_Vdt_GND))*(pInst->Tk+pModel->TVGEB)-((pModel->AVGEB*pInst->Tk)*pInst->Tk)*Tk_Vdt_GND)/(pInst->Tk+pModel->TVGEB)/(pInst->Tk+pModel->TVGEB)))+(0.1*(-dxa_Vdt_GND)*d10_exp0*d10_logE1));
#endif
VGZEB_T=((VGZEBOK-(((pModel->AVGEB*pInst->Tk)*pInst->Tk)/(pInst->Tk+pModel->TVGEB)))+(0.1*d00_logE1));
EXIT_IF_ISNAN(((VGZEBOK-(((pModel->AVGEB*pInst->Tk)*pInst->Tk)/(pInst->Tk+pModel->TVGEB)))+(0.1*d00_logE1)))
}
}
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
VGZEB_T_Vdt_GND=VGZEB_T_Vdt_GND;
#endif
VGZEB_T=VGZEB_T;
EXIT_IF_ISNAN(VGZEB_T)
{
double m00_logE(d00_logE0,tN)
#if defined(_DERIVATE)
double m10_logE(d10_logE0,d00_logE0,tN)
...
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
inv_VDE_T_Vdt_GND=(-VDE_T_Vdt_GND/VDE_T/VDE_T);
#endif
inv_VDE_T=(1.0/VDE_T);
EXIT_IF_ISNAN((1.0/VDE_T))
{
double m00_pow(d00_pow0,(pModel->VDE*inv_VDE_T),pModel->PE)
#if defined(_DERIVATE)
double m10_pow(d10_pow0,d00_pow0,(pModel->VDE*inv_VDE_T),pModel->PE)
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
CJE_T_div_CJE_Vdt_GND=(d10_pow0*(pModel->VDE*inv_VDE_T_Vdt_GND));
#endif
CJE_T_div_CJE=d00_pow0;
EXIT_IF_ISNAN(d00_pow0)
}
#if defined(_DYNAMIC)
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
CJE_T_Vdt_GND=(pModel->CJE*CJE_T_div_CJE_Vdt_GND);
#endif
CJE_T=(pModel->CJE*CJE_T_div_CJE);
EXIT_IF_ISNAN((pModel->CJE*CJE_T_div_CJE))
#endif
#if defined(_DYNAMIC)
{
...
{
double m00_exp(d00_exp0,(lntN*pModel->AE))
#if defined(_DERIVATE)
#define d10_exp0 d00_exp0
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
RE_T_Vdt_GND=(pModel->RE*lntN_Vdt_GND*pModel->AE*d10_exp0);
#endif
RE_T=(pModel->RE*d00_exp0);
EXIT_IF_ISNAN((pModel->RE*d00_exp0))
}
{
double m00_exp(d00_exp0,(lntN*(pModel->AB-pModel->AQBO)))
#if defined(_DERIVATE)
#define d10_exp0 d00_exp0
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
RBV_T_Vdt_GND=(pModel->RBV*lntN_Vdt_GND*(pModel->AB-pModel->AQBO)*d10_exp0);
#endif
RBV_T=(pModel->RBV*d00_exp0);
EXIT_IF_ISNAN((pModel->RBV*d00_exp0))
}
{
double m00_exp(d00_exp0,(lntN*pModel->AEX))
#if defined(_DERIVATE)
#define d10_exp0 d00_exp0
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
RBC_T_Vdt_GND=(pModel->RBC*lntN_Vdt_GND*pModel->AEX*d10_exp0);
#endif
RBC_T=(pModel->RBC*d00_exp0);
EXIT_IF_ISNAN((pModel->RBC*d00_exp0))
}
{
double m00_exp(d00_exp0,(lntN*pModel->AC))
#if defined(_DERIVATE)
#define d10_exp0 d00_exp0
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
RCCxx_T_Vdt_GND=(pModel->RCC*lntN_Vdt_GND*pModel->AC*d10_exp0);
#endif
RCCxx_T=(pModel->RCC*d00_exp0);
EXIT_IF_ISNAN((pModel->RCC*d00_exp0))
}
{
double m00_exp(d00_exp0,(lntN*pModel->ACBL))
#if defined(_DERIVATE)
#define d10_exp0 d00_exp0
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
RCCex_T_Vdt_GND=(pModel->RCBLX*lntN_Vdt_GND*pModel->ACBL*d10_exp0);
#endif
RCCex_T=(pModel->RCBLX*d00_exp0);
EXIT_IF_ISNAN((pModel->RCBLX*d00_exp0))
}
{
double m00_exp(d00_exp0,(lntN*pModel->ACBL))
#if defined(_DERIVATE)
...
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
RCCin_T_Vdt_GND=(pModel->RCBLI*lntN_Vdt_GND*pModel->ACBL*d10_exp0);
#endif
RCCin_T=(pModel->RCBLI*d00_exp0);
EXIT_IF_ISNAN((pModel->RCBLI*d00_exp0))
}
{
double m00_exp(d00_exp0,(lntN*pModel->AEPI))
#if defined(_DERIVATE)
#define d10_exp0 d00_exp0
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
RCV_T_Vdt_GND=(pModel->RCV*lntN_Vdt_GND*pModel->AEPI*d10_exp0);
#endif
RCV_T=(pModel->RCV*d00_exp0);
EXIT_IF_ISNAN((pModel->RCV*d00_exp0))
}
{
double m00_exp(d00_exp0,(lntN*((pModel->AE-pModel->AB)-pModel->AQBO)))
...
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
BF_T_Vdt_GND=(((pModel->BF*lntN_Vdt_GND*((pModel->AE-pModel->AB)-pModel->AQBO)*d10_exp0)*d00_exp1)+((pModel->BF*d00_exp0)*((-pModel->DVGBF)*VdtINV_Vdt_GND)*d10_exp1));
#endif
BF_T=((pModel->BF*d00_exp0)*d00_exp1);
EXIT_IF_ISNAN(((pModel->BF*d00_exp0)*d00_exp1))
}
{
...
{
double m00_exp(d00_exp0,(lntN*(((4.0-pModel->AB)-pModel->AQBO)+pModel->DAIS)))
...
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
IS_T_Vdt_GND=(((pModel->IS*lntN_Vdt_GND*(((4.0-pModel->AB)-pModel->AQBO)+pModel->DAIS)*d10_exp0)*d00_exp1)+((pModel->IS*d00_exp0)*((-pModel->VGB)*VdtINV_Vdt_GND)*d10_exp1));
#endif
IS_T=((pModel->IS*d00_exp0)*d00_exp1);
EXIT_IF_ISNAN(((pModel->IS*d00_exp0)*d00_exp1))
}
{
double m00_exp(d00_exp0,(lntN*(1.0-pModel->AB)))
#if defined(_DERIVATE)
#define d10_exp0 d00_exp0
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
IK_T_Vdt_GND=(pModel->IK*lntN_Vdt_GND*(1.0-pModel->AB)*d10_exp0);
#endif
IK_T=(pModel->IK*d00_exp0);
EXIT_IF_ISNAN((pModel->IK*d00_exp0))
}
{
double m00_exp(d00_exp0,(lntN*(6.0-(2.0*pModel->MLF))))
...
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
IBF_T_Vdt_GND=(((pModel->IBF*lntN_Vdt_GND*(6.0-(2.0*pModel->MLF))*d10_exp0)*d00_exp1)+((pModel->IBF*d00_exp0)*(((-pModel->VGJ)*VdtINV_Vdt_GND)/pModel->MLF)*d10_exp1));
#endif
IBF_T=((pModel->IBF*d00_exp0)*d00_exp1);
EXIT_IF_ISNAN(((pModel->IBF*d00_exp0)*d00_exp1))
}
{
...
{
double m00_pow(d00_pow0,(VGZEB_T*inv_VGZEB_Tr),(-0.5))
#if defined(_DERIVATE)
double m10_pow(d10_pow0,d00_pow0,(VGZEB_T*inv_VGZEB_Tr),(-0.5))
#endif
#if defined(_DERIVATE) /* probe=V(b2,e1)V(dt,GND) ddxprobe= */
x_Vb2_e1=0.0;
x_Vdt_GND=(d10_pow0*VGZEB_T_Vdt_GND*inv_VGZEB_Tr);
#endif
x=d00_pow0;
EXIT_IF_ISNAN(d00_pow0)
}
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
y_Vdt_GND=(-CJE_T_div_CJE_Vdt_GND/CJE_T_div_CJE/CJE_T_div_CJE);
#endif
y=(1.0/CJE_T_div_CJE);
EXIT_IF_ISNAN((1.0/CJE_T_div_CJE))
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
nZEB_T_Vdt_GND=(((((((((pModel->NZEB*VGZEB_T_Vdt_GND)*VGZEB_T)+((pModel->NZEB*VGZEB_T)*VGZEB_T_Vdt_GND))*x)+(((pModel->NZEB*VGZEB_T)*VGZEB_T)*x_Vdt_GND))*y)+((((pModel->NZEB*VGZEB_T)*VGZEB_T)*x)*y_Vdt_GND))*pModel->VDE*inv_VDE_T)+((((((pModel->NZEB*VGZEB_T)*VGZEB_T)*x)*y)*pModel->VDE)*inv_VDE_T_Vdt_GND))*inv_VGZEB_Tr*inv_VGZEB_Tr;
#endif
nZEB_T=((((((((pModel->NZEB*VGZEB_T)*VGZEB_T)*x)*y)*pModel->VDE)*inv_VDE_T)*inv_VGZEB_Tr)*inv_VGZEB_Tr);
EXIT_IF_ISNAN(((((((((pModel->NZEB*VGZEB_T)*VGZEB_T)*x)*y)*pModel->VDE)*inv_VDE_T)*inv_VGZEB_Tr)*inv_VGZEB_Tr))
{
double m00_exp(d00_exp0,(pModel->NZEB-nZEB_T))
#if defined(_DERIVATE)
#define d10_exp0 d00_exp0
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
IZEB_T_Vdt_GND=(((((((((pModel->IZEB*x_Vdt_GND)*VDE_T)+((pModel->IZEB*x)*VDE_T_Vdt_GND))*VDE_T)+(((pModel->IZEB*x)*VDE_T)*VDE_T_Vdt_GND))*inv_VDE*inv_VDE*CJE_T_div_CJE)+((((((pModel->IZEB*x)*VDE_T)*VDE_T)*inv_VDE)*inv_VDE)*CJE_T_div_CJE_Vdt_GND))*d00_exp0)+(((((((pModel->IZEB*x)*VDE_T)*VDE_T)*inv_VDE)*inv_VDE)*CJE_T_div_CJE)*(-nZEB_T_Vdt_GND)*d10_exp0));
#endif
IZEB_T=(((((((pModel->IZEB*x)*VDE_T)*VDE_T)*inv_VDE)*inv_VDE)*CJE_T_div_CJE)*d00_exp0);
EXIT_IF_ISNAN((((((((pModel->IZEB*x)*VDE_T)*VDE_T)*inv_VDE)*inv_VDE)*CJE_T_div_CJE)*d00_exp0))
}
{
double m00_exp(d00_exp0,(lntN*pModel->AQBO))
#if defined(_DERIVATE)
#define d10_exp0 d00_exp0
#endif
#if defined(_DERIVATE) /* probe=V(b2,e1)V(dt,GND) ddxprobe= */
x_Vb2_e1=0.0;
x_Vdt_GND=lntN_Vdt_GND*pModel->AQBO*d10_exp0;
#endif
x=d00_exp0;
EXIT_IF_ISNAN(d00_exp0)
}
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
VEF_T_Vdt_GND=(((pModel->VEF*x_Vdt_GND)*CJCscaleINV)+((pModel->VEF*x)*CJCscaleINV_Vdt_GND));
#endif
VEF_T=((pModel->VEF*x)*CJCscaleINV);
EXIT_IF_ISNAN(((pModel->VEF*x)*CJCscaleINV))
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
VER_T_Vdt_GND=(((pModel->VER*x_Vdt_GND)*y)+((pModel->VER*x)*y_Vdt_GND));
#endif
VER_T=((pModel->VER*x)*y);
EXIT_IF_ISNAN(((pModel->VER*x)*y))
{
double m00_exp(d00_exp0,(lntN*(4.0-pModel->AS)))
...
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
ISS_T_Vdt_GND=(((pModel->ISS*lntN_Vdt_GND*(4.0-pModel->AS)*d10_exp0)*d00_exp1)+((pModel->ISS*d00_exp0)*((-pModel->VGS)*VdtINV_Vdt_GND)*d10_exp1));
#endif
ISS_T=((pModel->ISS*d00_exp0)*d00_exp1);
EXIT_IF_ISNAN(((pModel->ISS*d00_exp0)*d00_exp1))
}
{
double m00_exp(d00_exp0,(lntN*(3.5-(0.5*pModel->ASUB))))
double m00_exp(d00_exp1,((-pModel->VGS)*VdtINV))
#if defined(_DERIVATE)
#define d10_exp0 d00_exp0
#define d10_exp1 d00_exp1
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
ICSS_T_Vdt_GND=(((pModel->ICSS*lntN_Vdt_GND*(3.5-(0.5*pModel->ASUB))*d10_exp0)*d00_exp1)+((pModel->ICSS*d00_exp0)*((-pModel->VGS)*VdtINV_Vdt_GND)*d10_exp1));
#endif
ICSS_T=((pModel->ICSS*d00_exp0)*d00_exp1);
EXIT_IF_ISNAN(((pModel->ICSS*d00_exp0)*d00_exp1))
}
if
((ISS_T>0.0))
{
{
double m00_exp(d00_exp0,(lntN*(1.0-pModel->AS)))
#if defined(_DERIVATE)
#define d10_exp0 d00_exp0
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
IKS_T_Vdt_GND=(((((pModel->IKS*lntN_Vdt_GND*(1.0-pModel->AS)*d10_exp0)*(IS_T/pModel->IS))+((pModel->IKS*d00_exp0)*(IS_T_Vdt_GND/pModel->IS)))*(pModel->ISS/ISS_T))+(((pModel->IKS*d00_exp0)*(IS_T/pModel->IS))*(-pModel->ISS*ISS_T_Vdt_GND/ISS_T/ISS_T)));
#endif
IKS_T=(((pModel->IKS*d00_exp0)*(IS_T/pModel->IS))*(pModel->ISS/ISS_T));
EXIT_IF_ISNAN((((pModel->IKS*d00_exp0)*(IS_T/pModel->IS))*(pModel->ISS/ISS_T)))
}
}
else
{
...
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
IKS_T_Vdt_GND=(pModel->IKS*lntN_Vdt_GND*(1.0-pModel->AS)*d10_exp0);
#endif
IKS_T=(pModel->IKS*d00_exp0);
EXIT_IF_ISNAN((pModel->IKS*d00_exp0))
}
}
#if defined(_DYNAMIC)
{
double m00_exp(d00_exp0,(lntN*(pModel->AB-2.0)))
...
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
TAUE_T_Vdt_GND=(((pModel->TAUE*lntN_Vdt_GND*(pModel->AB-2.0)*d10_exp0)*d00_exp1)+((pModel->TAUE*d00_exp0)*((-pModel->DVGTE)*VdtINV_Vdt_GND)*d10_exp1));
#endif
TAUE_T=((pModel->TAUE*d00_exp0)*d00_exp1);
EXIT_IF_ISNAN(((pModel->TAUE*d00_exp0)*d00_exp1))
}
#endif
#if defined(_DYNAMIC)
{
double m00_exp(d00_exp0,(lntN*((pModel->AQBO+pModel->AB)-1.0)))
#if defined(_DERIVATE)
#define d10_exp0 d00_exp0
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
TAUB_T_Vdt_GND=(pModel->TAUB*lntN_Vdt_GND*((pModel->AQBO+pModel->AB)-1.0)*d10_exp0);
#endif
TAUB_T=(pModel->TAUB*d00_exp0);
EXIT_IF_ISNAN((pModel->TAUB*d00_exp0))
}
#endif
#if defined(_DYNAMIC)
{
double m00_exp(d00_exp0,(lntN*(pModel->AEPI-1.0)))
#if defined(_DERIVATE)
#define d10_exp0 d00_exp0
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
TEPI_T_Vdt_GND=(pModel->TEPI*lntN_Vdt_GND*(pModel->AEPI-1.0)*d10_exp0);
#endif
TEPI_T=(pModel->TEPI*d00_exp0);
EXIT_IF_ISNAN((pModel->TEPI*d00_exp0))
}
#endif
#if defined(_DYNAMIC)
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
...
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
DEG_T_Vdt_GND=(pModel->DEG*lntN_Vdt_GND*pModel->AQBO*d10_exp0);
#endif
DEG_T=(pModel->DEG*d00_exp0);
EXIT_IF_ISNAN((pModel->DEG*d00_exp0))
}
{
...
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
IZEB_TM_Vdt_GND=IZEB_T_Vdt_GND*pModel->MULT;
#endif
IZEB_TM=(IZEB_T*pModel->MULT);
EXIT_IF_ISNAN((IZEB_T*pModel->MULT))
...
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
ICSS_TM_Vdt_GND=ICSS_T_Vdt_GND*pModel->MULT;
#endif
ICSS_TM=(ICSS_T*pModel->MULT);
EXIT_IF_ISNAN((ICSS_T*pModel->MULT))
#if defined(_DERIVATE) /* probe=V(dt,GND) ddxprobe= */
...
Ic1c2_Vc1_c2=((Vc1c2_Vc1_c2/RCV_TM)+(_circuit_gmin*Vc1c2_Vc1_c2));
#endif
Ic1c2=(((Ec+Vc1c2)/RCV_TM)+(_circuit_gmin*Vc1c2));
EXIT_IF_ISNAN((((Ec+Vc1c2)/RCV_TM)+(_circuit_gmin*Vc1c2)))
if
((Ic1c2>0.0))
{
if
...
EXIT_IF_ISNAN(Vje)
{
double m00_pow(d00_pow0,(1.0-(Vje*inv_VDE_T)),(1.0-pModel->PE))
#if defined(_DERIVATE)
double m10_pow(d10_pow0,d00_pow0,(1.0-(Vje*inv_VDE_T)),(1.0-pModel->PE))
#endif
#if defined(_DERIVATE) /* probe=V(b2,e1)V(dt,GND)V(b2,c2)V(b2,c1)V(c1,c2) ddxprobe= */
E0BE_Vb2_e1=(d10_pow0*(-Vje_Vb2_e1*inv_VDE_T));
E0BE_Vdt_GND=(d10_pow0*(-((Vje_Vdt_GND*inv_VDE_T)+(Vje*inv_VDE_T_Vdt_GND))));
E0BE_Vb2_c2=(d10_pow0*(-Vje_Vb2_c2*inv_VDE_T));
E0BE_Vb2_c1=(d10_pow0*(-Vje_Vb2_c1*inv_VDE_T));
E0BE_Vc1_c2=(d10_pow0*(-Vje_Vc1_c2*inv_VDE_T));
#endif
E0BE=d00_pow0;
EXIT_IF_ISNAN(d00_pow0)
}
#if defined(_DERIVATE) /* probe=V(dt,GND)V(b2,e1)V(b2,c2)V(b2,c1)V(c1,c2) ddxprobe= */
Vte_Vdt_GND=((((VDE_T_Vdt_GND/(1.0-pModel->PE))*(1.0-E0BE))+((VDE_T/(1.0-pModel->PE))*(-E0BE_Vdt_GND)))+(3.0*(-Vje_Vdt_GND)));
Vte_Vb2_e1=(((VDE_T/(1.0-pModel->PE))*(-E0BE_Vb2_e1))+(3.0*(Vb2e1_Vb2_e1-Vje_Vb2_e1)));
Vte_Vb2_c2=(((VDE_T/(1.0-pModel->PE))*(-E0BE_Vb2_c2))+(3.0*(-Vje_Vb2_c2)));
Vte_Vb2_c1=(((VDE_T/(1.0-pModel->PE))*(-E0BE_Vb2_c1))+(3.0*(-Vje_Vb2_c1)));
Vte_Vc1_c2=(((VDE_T/(1.0-pModel->PE))*(-E0BE_Vc1_c2))+(3.0*(-Vje_Vc1_c2)));
#endif
Vte=(((VDE_T/(1.0-pModel->PE))*(1.0-E0BE))+(3.0*(Vb2e1-Vje)));
EXIT_IF_ISNAN((((VDE_T/(1.0-pModel->PE))*(1.0-E0BE))+(3.0*(Vb2e1-Vje))))
...
if
((((pModel->IZEB>0.0)&&(pModel->NZEB>0.0))&&(Vb2e1<0)))
{
if
(((nZEB_T*(1-(pow2_2mPE/(2.0*E0BE))))<200.0))
{
{
double m00_exp(d00_exp0,(nZEB_T*(1-(pow2_2mPE/(2.0*E0BE)))))
#if defined(_DERIVATE)
#define d10_exp0 d00_exp0
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND)V(b2,e1)V(b2,c2)V(b2,c1)V(c1,c2) ddxprobe= */
eZEB_Vdt_GND=((nZEB_T_Vdt_GND*(1-(pow2_2mPE/(2.0*E0BE))))+(nZEB_T*(-(-pow2_2mPE*(2.0*E0BE_Vdt_GND)/(2.0*E0BE)/(2.0*E0BE)))))*d10_exp0;
eZEB_Vb2_e1=(nZEB_T*(-(-pow2_2mPE*(2.0*E0BE_Vb2_e1)/(2.0*E0BE)/(2.0*E0BE))))*d10_exp0;
eZEB_Vb2_c2=(nZEB_T*(-(-pow2_2mPE*(2.0*E0BE_Vb2_c2)/(2.0*E0BE)/(2.0*E0BE))))*d10_exp0;
eZEB_Vb2_c1=(nZEB_T*(-(-pow2_2mPE*(2.0*E0BE_Vb2_c1)/(2.0*E0BE)/(2.0*E0BE))))*d10_exp0;
eZEB_Vc1_c2=(nZEB_T*(-(-pow2_2mPE*(2.0*E0BE_Vc1_c2)/(2.0*E0BE)/(2.0*E0BE))))*d10_exp0;
#endif
eZEB=d00_exp0;
EXIT_IF_ISNAN(d00_exp0)
}
...
#if defined(_DERIVATE) /* probe=V(dt,GND)V(b2,e1)V(b2,c2)V(b2,c1)V(c1,c2) ddxprobe= */
eZEB_Vdt_GND=(expl*((nZEB_T_Vdt_GND*(1-(pow2_2mPE/(2.0*E0BE))))+(nZEB_T*(-(-pow2_2mPE*(2.0*E0BE_Vdt_GND)/(2.0*E0BE)/(2.0*E0BE))))));
eZEB_Vb2_e1=(expl*(nZEB_T*(-(-pow2_2mPE*(2.0*E0BE_Vb2_e1)/(2.0*E0BE)/(2.0*E0BE)))));
eZEB_Vb2_c2=(expl*(nZEB_T*(-(-pow2_2mPE*(2.0*E0BE_Vb2_c2)/(2.0*E0BE)/(2.0*E0BE)))));
eZEB_Vb2_c1=(expl*(nZEB_T*(-(-pow2_2mPE*(2.0*E0BE_Vb2_c1)/(2.0*E0BE)/(2.0*E0BE)))));
eZEB_Vc1_c2=(expl*(nZEB_T*(-(-pow2_2mPE*(2.0*E0BE_Vc1_c2)/(2.0*E0BE)/(2.0*E0BE)))));
#endif
eZEB=(expl*(1.0+((nZEB_T*(1-(pow2_2mPE/(2.0*E0BE))))-200.0)));
EXIT_IF_ISNAN((expl*(1.0+((nZEB_T*(1-(pow2_2mPE/(2.0*E0BE))))-200.0))))
}
#if defined(_DERIVATE) /* probe=V(b2,e1)V(dt,GND) ddxprobe= */
x_Vb2_e1=Vb2e1_Vb2_e1*inv_VDE_T;
x_Vdt_GND=(Vb2e1*inv_VDE_T_Vdt_GND);
#endif
x=(Vb2e1*inv_VDE_T);
EXIT_IF_ISNAN((Vb2e1*inv_VDE_T))
{
double m00_pow(d00_pow0,(-x),((-2.0)-pModel->PE))
#if defined(_DERIVATE)
double m10_pow(d10_pow0,d00_pow0,(-x),((-2.0)-pModel->PE))
#endif
#if defined(_DERIVATE) /* probe=V(b2,e1)V(dt,GND) ddxprobe= */
dE0BE_Vb2_e1=(((d10_pow0*(-x_Vb2_e1))*((pModel->PE*((1-(pModel->PE*pModel->PE))-((3*x)*(pModel->PE-1))))-(((6*x)*x)*((pModel->PE-1)+x))))+(d00_pow0*((pModel->PE*(-(3*x_Vb2_e1)*(pModel->PE-1)))-(((((6*x_Vb2_e1)*x)+((6*x)*x_Vb2_e1))*((pModel->PE-1)+x))+(((6*x)*x)*x_Vb2_e1)))))*0.16666666666666666667;
dE0BE_Vdt_GND=(((d10_pow0*(-x_Vdt_GND))*((pModel->PE*((1-(pModel->PE*pModel->PE))-((3*x)*(pModel->PE-1))))-(((6*x)*x)*((pModel->PE-1)+x))))+(d00_pow0*((pModel->PE*(-(3*x_Vdt_GND)*(pModel->PE-1)))-(((((6*x_Vdt_GND)*x)+((6*x)*x_Vdt_GND))*((pModel->PE-1)+x))+(((6*x)*x)*x_Vdt_GND)))))*0.16666666666666666667;
#endif
dE0BE=((d00_pow0*((pModel->PE*((1-(pModel->PE*pModel->PE))-((3*x)*(pModel->PE-1))))-(((6*x)*x)*((pModel->PE-1)+x))))*0.16666666666666666667);
EXIT_IF_ISNAN(((d00_pow0*((pModel->PE*((1-(pModel->PE*pModel->PE))-((3*x)*(pModel->PE-1))))-(((6*x)*x)*((pModel->PE-1)+x))))*0.16666666666666666667))
}
if
(((((Vb2e1*pow2_2mPE)*nZEB_T)/(VGZEB_T*dE0BE))<200.0))
{
{
double m00_exp(d00_exp0,(((Vb2e1*pow2_2mPE)*nZEB_T)/(VGZEB_T*dE0BE)))
#if defined(_DERIVATE)
#define d10_exp0 d00_exp0
#endif
#if defined(_DERIVATE) /* probe=V(b2,e1)V(dt,GND) ddxprobe= */
edZEB_Vb2_e1=((Vb2e1_Vb2_e1*pow2_2mPE*nZEB_T*(VGZEB_T*dE0BE)-((Vb2e1*pow2_2mPE)*nZEB_T)*(VGZEB_T*dE0BE_Vb2_e1))/(VGZEB_T*dE0BE)/(VGZEB_T*dE0BE))*d10_exp0;
edZEB_Vdt_GND=((((Vb2e1*pow2_2mPE)*nZEB_T_Vdt_GND)*(VGZEB_T*dE0BE)-((Vb2e1*pow2_2mPE)*nZEB_T)*((VGZEB_T_Vdt_GND*dE0BE)+(VGZEB_T*dE0BE_Vdt_GND)))/(VGZEB_T*dE0BE)/(VGZEB_T*dE0BE))*d10_exp0;
#endif
edZEB=d00_exp0;
EXIT_IF_ISNAN(d00_exp0)
}
...
#if defined(_DERIVATE) /* probe=V(b2,e1)V(dt,GND) ddxprobe= */
edZEB_Vb2_e1=(expl*((Vb2e1_Vb2_e1*pow2_2mPE*nZEB_T*(VGZEB_T*dE0BE)-((Vb2e1*pow2_2mPE)*nZEB_T)*(VGZEB_T*dE0BE_Vb2_e1))/(VGZEB_T*dE0BE)/(VGZEB_T*dE0BE)));
edZEB_Vdt_GND=(expl*((((Vb2e1*pow2_2mPE)*nZEB_T_Vdt_GND)*(VGZEB_T*dE0BE)-((Vb2e1*pow2_2mPE)*nZEB_T)*((VGZEB_T_Vdt_GND*dE0BE)+(VGZEB_T*dE0BE_Vdt_GND)))/(VGZEB_T*dE0BE)/(VGZEB_T*dE0BE)));
#endif
edZEB=(expl*(1.0+((((Vb2e1*pow2_2mPE)*nZEB_T)/(VGZEB_T*dE0BE))-200.0)));
EXIT_IF_ISNAN((expl*(1.0+((((Vb2e1*pow2_2mPE)*nZEB_T)/(VGZEB_T*dE0BE))-200.0))))
}
#if defined(_DERIVATE) /* probe=V(b2,e1)V(dt,GND) ddxprobe= */
DZEB_Vb2_e1=((-Vb2e1_Vb2_e1)-((((VGZEB_T*dE0BE_Vb2_e1)*(1-edZEB))+((VGZEB_T*dE0BE)*(-edZEB_Vb2_e1)))/(pow2_2mPE*nZEB_T)));
DZEB_Vdt_GND=(-((((((VGZEB_T_Vdt_GND*dE0BE)+(VGZEB_T*dE0BE_Vdt_GND))*(1-edZEB))+((VGZEB_T*dE0BE)*(-edZEB_Vdt_GND)))*(pow2_2mPE*nZEB_T)-((VGZEB_T*dE0BE)*(1-edZEB))*(pow2_2mPE*nZEB_T_Vdt_GND))/(pow2_2mPE*nZEB_T)/(pow2_2mPE*nZEB_T)));
#endif
DZEB=((-Vb2e1)-(((VGZEB_T*dE0BE)*(1-edZEB))/(pow2_2mPE*nZEB_T)));
EXIT_IF_ISNAN(((-Vb2e1)-(((VGZEB_T*dE0BE)*(1-edZEB))/(pow2_2mPE*nZEB_T))))
#if defined(_DERIVATE) /* probe=V(dt,GND)V(b2,e1)V(b2,c2)V(b2,c1)V(c1,c2) ddxprobe= */
Izteb_Vdt_GND=(((((((((2.0*IZEB_TM_Vdt_GND)*DZEB)+((2.0*IZEB_TM)*DZEB_Vdt_GND))*E0BE)+(((2.0*IZEB_TM)*DZEB)*E0BE_Vdt_GND))*eZEB)+((((2.0*IZEB_TM)*DZEB)*E0BE)*eZEB_Vdt_GND))*inv_VDE_T)+(((((2.0*IZEB_TM)*DZEB)*E0BE)*eZEB)*inv_VDE_T_Vdt_GND))*pow2_PEm2;
Izteb_Vb2_e1=((((((2.0*IZEB_TM)*DZEB_Vb2_e1)*E0BE)+(((2.0*IZEB_TM)*DZEB)*E0BE_Vb2_e1))*eZEB)+((((2.0*IZEB_TM)*DZEB)*E0BE)*eZEB_Vb2_e1))*inv_VDE_T*pow2_PEm2;
Izteb_Vb2_c2=(((((2.0*IZEB_TM)*DZEB)*E0BE_Vb2_c2)*eZEB)+((((2.0*IZEB_TM)*DZEB)*E0BE)*eZEB_Vb2_c2))*inv_VDE_T*pow2_PEm2;
Izteb_Vb2_c1=(((((2.0*IZEB_TM)*DZEB)*E0BE_Vb2_c1)*eZEB)+((((2.0*IZEB_TM)*DZEB)*E0BE)*eZEB_Vb2_c1))*inv_VDE_T*pow2_PEm2;
Izteb_Vc1_c2=(((((2.0*IZEB_TM)*DZEB)*E0BE_Vc1_c2)*eZEB)+((((2.0*IZEB_TM)*DZEB)*E0BE)*eZEB_Vc1_c2))*inv_VDE_T*pow2_PEm2;
#endif
pInst->Izteb=((((((2.0*IZEB_TM)*DZEB)*E0BE)*eZEB)*inv_VDE_T)*pow2_PEm2);
EXIT_IF_ISNAN(((((((2.0*IZEB_TM)*DZEB)*E0BE)*eZEB)*inv_VDE_T)*pow2_PEm2))
}
else
{
#if defined(_DYNAMIC)
...
{
#if defined(_DERIVATE) /* probe=V(dt,GND)V(s,c1) ddxprobe= */
Isf_Vdt_GND=((ICSS_TM_Vdt_GND*(eVsc1-1.0))+(ICSS_TM*eVsc1_Vdt_GND));
Isf_Vs_c1=(ICSS_TM*eVsc1_Vs_c1);
#endif
Isf=(ICSS_TM*(eVsc1-1.0));
EXIT_IF_ISNAN((ICSS_TM*(eVsc1-1.0)))
}
...
Ib1b2_Vb1_b2=((((((2.0*Vt)*eVb1b2_Vb1_b2)+Vb1b2_Vb1_b2)*pInst->Rb2-(((2.0*Vt)*(pInst->eVb1b2-1.0))+Vb1b2)*Rb2_Vb1_b2)/pInst->Rb2/pInst->Rb2)+(_circuit_gmin*Vb1b2_Vb1_b2));
...
#endif
Ib1b2=(((((2.0*Vt)*(pInst->eVb1b2-1.0))+Vb1b2)/pInst->Rb2)+(_circuit_gmin*Vb1b2));
EXIT_IF_ISNAN((((((2.0*Vt)*(pInst->eVb1b2-1.0))+Vb1b2)/pInst->Rb2)+(_circuit_gmin*Vb1b2)))
...
power_Vdt_GND=(((((((((((((((((In_Vdt_GND*(Vb2e1-Vb2c2star))+(In*(-Vb2c2star_Vdt_GND)))+((Ic1c2_Vdt_GND*(Vb2c2star-Vb2c1))+(Ic1c2*Vb2c2star_Vdt_GND)))-((Iavl_Vdt_GND*Vb2c2star)+(Iavl*Vb2c2star_Vdt_GND)))+(-(Vee1*Vee1)*RE_TM_Vdt_GND/pInst->RE_TM/pInst->RE_TM))+((Vcc3*Vcc3)*GCCxx_TM_Vdt_GND))+((Vc3c4*Vc3c4)*GCCex_TM_Vdt_GND))+((Vc4c1*Vc4c1)*GCCin_TM_Vdt_GND))+(-(Vbb1*Vbb1)*RBC_TM_Vdt_GND/pInst->RBC_TM/pInst->RBC_TM))+Ib1b2_Vdt_GND*Vb1b2)+((Ib1_Vdt_GND+Ib2_Vdt_GND)-Izteb_Vdt_GND)*Vb2e1)+Ib1_s_Vdt_GND*Vb1e1)+(Iex_Vdt_GND+Ib3_Vdt_GND)*Vb1c4)+XIex_Vdt_GND*Vbc3)+Isub_Vdt_GND*(Vb1c4-Vsc4))+XIsub_Vdt_GND*(Vbc3-Vsc3))+Isf_Vdt_GND*Vsc1);
power_Vb2_e1=((((((((In_Vb2_e1*(Vb2e1-Vb2c2star))+(In*Vb2e1_Vb2_e1))-Iavl_Vb2_e1*Vb2c2star)+Ib1b2_Vb2_e1*Vb1b2)+((((Ib1_Vb2_e1+Ib2_Vb2_e1)-Izteb_Vb2_e1)*Vb2e1)+(((pInst->Ib1+pInst->Ib2)-pInst->Izteb)*Vb2e1_Vb2_e1)))+Ib3_Vb2_e1*Vb1c4)+XIex_Vb2_e1*Vbc3)+XIsub_Vb2_e1*(Vbc3-Vsc3));
power_Vb2_c2=(((((((((((In_Vb2_c2*(Vb2e1-Vb2c2star))+(In*(-Vb2c2star_Vb2_c2)))+((Ic1c2_Vb2_c2*(Vb2c2star-Vb2c1))+(Ic1c2*Vb2c2star_Vb2_c2)))-((Iavl_Vb2_c2*Vb2c2star)+(Iavl*Vb2c2star_Vb2_c2)))+((Vcc3_Vb2_c2*Vcc3)+(Vcc3*Vcc3_Vb2_c2))*pInst->GCCxx_TM)+Ib1b2_Vb2_c2*Vb1b2)+(Ib1_Vb2_c2-Izteb_Vb2_c2)*Vb2e1)+(((Iex_Vb2_c2+Ib3_Vb2_c2)*Vb1c4)+((pInst->Iex+pInst->Ib3)*Vb1c4_Vb2_c2)))+((XIex_Vb2_c2*Vbc3)+(pInst->XIex*Vbc3_Vb2_c2)))+((Isub_Vb2_c2*(Vb1c4-Vsc4))+(pInst->Isub*Vb1c4_Vb2_c2)))+((XIsub_Vb2_c2*(Vbc3-Vsc3))+(pInst->XIsub*Vbc3_Vb2_c2)));
power_Vb2_c1=((((((((In_Vb2_c1*(Vb2e1-Vb2c2star))+(In*(-Vb2c2star_Vb2_c1)))+((Ic1c2_Vb2_c1*(Vb2c2star-Vb2c1))+(Ic1c2*(Vb2c2star_Vb2_c1-Vb2c1_Vb2_c1))))-((Iavl_Vb2_c1*Vb2c2star)+(Iavl*Vb2c2star_Vb2_c1)))+Ib1b2_Vb2_c1*Vb1b2)+(Ib1_Vb2_c1-Izteb_Vb2_c1)*Vb2e1)+XIex_Vb2_c1*Vbc3)+XIsub_Vb2_c1*(Vbc3-Vsc3));
power_Vc1_c2=(((((((((((In_Vc1_c2*(Vb2e1-Vb2c2star))+(In*(-Vb2c2star_Vc1_c2)))+((Ic1c2_Vc1_c2*(Vb2c2star-Vb2c1))+(Ic1c2*Vb2c2star_Vc1_c2)))-((Iavl_Vc1_c2*Vb2c2star)+(Iavl*Vb2c2star_Vc1_c2)))+((Vcc3_Vc1_c2*Vcc3)+(Vcc3*Vcc3_Vc1_c2))*pInst->GCCxx_TM)+Ib1b2_Vc1_c2*Vb1b2)+(Ib1_Vc1_c2-Izteb_Vc1_c2)*Vb2e1)+(((Iex_Vc1_c2+Ib3_Vc1_c2)*Vb1c4)+((pInst->Iex+pInst->Ib3)*Vb1c4_Vc1_c2)))+((XIex_Vc1_c2*Vbc3)+(pInst->XIex*Vbc3_Vc1_c2)))+((Isub_Vc1_c2*(Vb1c4-Vsc4))+(pInst->Isub*Vb1c4_Vc1_c2)))+((XIsub_Vc1_c2*(Vbc3-Vsc3))+(pInst->XIsub*Vbc3_Vc1_c2)));
...
#endif
power=((((((((((((((((In*(Vb2e1-Vb2c2star))+(Ic1c2*(Vb2c2star-Vb2c1)))-(Iavl*Vb2c2star))+((Vee1*Vee1)/pInst->RE_TM))+((Vcc3*Vcc3)*pInst->GCCxx_TM))+((Vc3c4*Vc3c4)*pInst->GCCex_TM))+((Vc4c1*Vc4c1)*pInst->GCCin_TM))+((Vbb1*Vbb1)/pInst->RBC_TM))+(Ib1b2*Vb1b2))+(((pInst->Ib1+pInst->Ib2)-pInst->Izteb)*Vb2e1))+(pInst->Ib1_s*Vb1e1))+((pInst->Iex+pInst->Ib3)*Vb1c4))+(pInst->XIex*Vbc3))+(pInst->Isub*(Vb1c4-Vsc4)))+(pInst->XIsub*(Vbc3-Vsc3)))+(Isf*Vsc1));
...
#if defined(_DYNAMIC)
{
double m00_pow(d00_pow0,(1.0-(Vje_s*inv_VDE_T)),(1.0-pModel->PE))
#if defined(_DERIVATE)
double m10_pow(d10_pow0,d00_pow0,(1.0-(Vje_s*inv_VDE_T)),(1.0-pModel->PE))
#endif
#if defined(_DERIVATE) /* probe=V(dt,GND)V(b1,e1)V(b2,e1)V(b2,c2)V(b2,c1)V(c1,c2) ddxprobe= */
Qte_s_Vdt_GND=(((pModel->XCJE*CJE_TM_Vdt_GND)*(((VDE_T/(1.0-pModel->PE))*(1.0-d00_pow0))+(3.0*(Vb1e1-Vje_s))))+((pModel->XCJE*CJE_TM)*((((VDE_T_Vdt_GND/(1.0-pModel->PE))*(1.0-d00_pow0))+((VDE_T/(1.0-pModel->PE))*(-(d10_pow0*(-((Vje_s_Vdt_GND*inv_VDE_T)+(Vje_s*inv_VDE_T_Vdt_GND)))))))+(3.0*(-Vje_s_Vdt_GND)))));
Qte_s_Vb1_e1=((pModel->XCJE*CJE_TM)*(((VDE_T/(1.0-pModel->PE))*(-(d10_pow0*(-Vje_s_Vb1_e1*inv_VDE_T))))+(3.0*(Vb1e1_Vb1_e1-Vje_s_Vb1_e1))));
Qte_s_Vb2_e1=((pModel->XCJE*CJE_TM)*(((VDE_T/(1.0-pModel->PE))*(-(d10_pow0*(-Vje_s_Vb2_e1*inv_VDE_T))))+(3.0*(-Vje_s_Vb2_e1))));
Qte_s_Vb2_c2=((pModel->XCJE*CJE_TM)*(((VDE_T/(1.0-pModel->PE))*(-(d10_pow0*(-Vje_s_Vb2_c2*inv_VDE_T))))+(3.0*(-Vje_s_Vb2_c2))));
Qte_s_Vb2_c1=((pModel->XCJE*CJE_TM)*(((VDE_T/(1.0-pModel->PE))*(-(d10_pow0*(-Vje_s_Vb2_c1*inv_VDE_T))))+(3.0*(-Vje_s_Vb2_c1))));
Qte_s_Vc1_c2=((pModel->XCJE*CJE_TM)*(((VDE_T/(1.0-pModel->PE))*(-(d10_pow0*(-Vje_s_Vc1_c2*inv_VDE_T))))+(3.0*(-Vje_s_Vc1_c2))));
#endif
...
#if defined(_DYNAMIC)
{
double m00_pow(d00_pow0,(1.0-(Vje*inv_VDE_T)),(-pModel->PE))
#if defined(_DERIVATE)
double m10_pow(d10_pow0,d00_pow0,(1.0-(Vje*inv_VDE_T)),(-pModel->PE))
#endif
#if defined(_DERIVATE) /* probe=V(b2,e1)V(dt,GND)V(b2,c2)V(b2,c1)V(c1,c2) ddxprobe= */
dVteVje_Vb2_e1=(d10_pow0*(-Vje_Vb2_e1*inv_VDE_T));
dVteVje_Vdt_GND=(d10_pow0*(-((Vje_Vdt_GND*inv_VDE_T)+(Vje*inv_VDE_T_Vdt_GND))));
dVteVje_Vb2_c2=(d10_pow0*(-Vje_Vb2_c2*inv_VDE_T));
dVteVje_Vb2_c1=(d10_pow0*(-Vje_Vb2_c1*inv_VDE_T));
dVteVje_Vc1_c2=(d10_pow0*(-Vje_Vc1_c2*inv_VDE_T));
#endif
...
#if defined(_DYNAMIC)
#if defined(_DERIVATE) /* probe=V(dt,GND)V(b2,e1)V(b,c)V(b,b1)V(b1,b2)V(c4,c1)V(c3,c1)V(c3,c4)V(b2,c2)V(b2,c1)V(c1,c2) ddxprobe= */
Qbc_Vdt_GND=(Qbe_qs_Vdt_GND*0.33333333333333333333+Qbc_qs_Vdt_GND);
Qbc_Vb2_e1=(Qbe_qs_Vb2_e1*0.33333333333333333333+Qbc_qs_Vb2_e1);
Qbc_Vb_c=(Qbe_qs_Vb_c*0.33333333333333333333+Qbc_qs_Vb_c);
Qbc_Vb_b1=(Qbe_qs_Vb_b1*0.33333333333333333333+Qbc_qs_Vb_b1);
Qbc_Vb1_b2=(Qbe_qs_Vb1_b2*0.33333333333333333333+Qbc_qs_Vb1_b2);
Qbc_Vc4_c1=(Qbe_qs_Vc4_c1*0.33333333333333333333+Qbc_qs_Vc4_c1);
Qbc_Vc3_c1=(Qbe_qs_Vc3_c1*0.33333333333333333333+Qbc_qs_Vc3_c1);
Qbc_Vc3_c4=(Qbe_qs_Vc3_c4*0.33333333333333333333+Qbc_qs_Vc3_c4);
Qbc_Vb2_c2=(Qbe_qs_Vb2_c2*0.33333333333333333333+Qbc_qs_Vb2_c2);
Qbc_Vb2_c1=(Qbe_qs_Vb2_c1*0.33333333333333333333+Qbc_qs_Vb2_c1);
Qbc_Vc1_c2=(Qbe_qs_Vc1_c2*0.33333333333333333333+Qbc_qs_Vc1_c2);
#endif
Qbc=((Qbe_qs*0.33333333333333333333)+Qbc_qs);
EXIT_IF_ISNAN(((Qbe_qs*0.33333333333333333333)+Qbc_qs))
#endif
#if defined(_DYNAMIC)
#if defined(_DERIVATE) /* probe=V(dt,GND)V(b2,e1)V(b,c)V(b,b1)V(b1,b2)V(c4,c1)V(c3,c1)V(c3,c4)V(b2,c2)V(b2,c1)V(c1,c2) ddxprobe= */
Qbe_Vdt_GND=(2.0*Qbe_qs_Vdt_GND)*0.33333333333333333333;
Qbe_Vb2_e1=(2.0*Qbe_qs_Vb2_e1)*0.33333333333333333333;
Qbe_Vb_c=(2.0*Qbe_qs_Vb_c)*0.33333333333333333333;
Qbe_Vb_b1=(2.0*Qbe_qs_Vb_b1)*0.33333333333333333333;
Qbe_Vb1_b2=(2.0*Qbe_qs_Vb1_b2)*0.33333333333333333333;
Qbe_Vc4_c1=(2.0*Qbe_qs_Vc4_c1)*0.33333333333333333333;
Qbe_Vc3_c1=(2.0*Qbe_qs_Vc3_c1)*0.33333333333333333333;
Qbe_Vc3_c4=(2.0*Qbe_qs_Vc3_c4)*0.33333333333333333333;
Qbe_Vb2_c2=(2.0*Qbe_qs_Vb2_c2)*0.33333333333333333333;
Qbe_Vb2_c1=(2.0*Qbe_qs_Vb2_c1)*0.33333333333333333333;
Qbe_Vc1_c2=(2.0*Qbe_qs_Vc1_c2)*0.33333333333333333333;
#endif
Qbe=((2.0*Qbe_qs)*0.33333333333333333333);
EXIT_IF_ISNAN(((2.0*Qbe_qs)*0.33333333333333333333))
#endif
}
else
{
...
EXIT_IF_ISNAN(Qbc_qs)
  ...
  _load_static_residual2(b2,e1,(pModel->TYPE*((pInst->Ib1+pInst->Ib2)-pInst->Izteb)))
  _load_static_jacobian4(b2,e1,b2,e1,(pModel->TYPE*((Ib1_Vb2_e1+Ib2_Vb2_e1)-Izteb_Vb2_e1)))
  _load_static_jacobian2s(b2,e1,dt,(pModel->TYPE*((Ib1_Vdt_GND+Ib2_Vdt_GND)-Izteb_Vdt_GND)))
  _load_static_jacobian4(b2,e1,c1,c2,(pModel->TYPE*(Ib1_Vc1_c2-Izteb_Vc1_c2)))
  _load_static_jacobian4(b2,e1,b2,c1,(pModel->TYPE*(Ib1_Vb2_c1-Izteb_Vb2_c1)))
  _load_static_jacobian4(b2,e1,b2,c2,(pModel->TYPE*(Ib1_Vb2_c2-Izteb_Vb2_c2)))
...
#if defined(_DERIVATE) /* probe=V(dt,GND)V(b,c)V(b,b1)V(b1,b2)V(c4,c1)V(c3,c1)V(c3,c4)V(b2,e1)V(b2,c2)V(b2,c1)V(c1,c2) ddxprobe= */
powerRBV_Vdt_GND=((((common_Vdt_GND*pInst->Rb2-common*Rb2_Vdt_GND)/pInst->Rb2/pInst->Rb2)*((4.0*pInst->eVb1b2)+5.0))+((common/pInst->Rb2)*(4.0*eVb1b2_Vdt_GND)))*0.33333333333333333333;
powerRBV_Vb_c=(-common*Rb2_Vb_c/pInst->Rb2/pInst->Rb2)*((4.0*pInst->eVb1b2)+5.0)*0.33333333333333333333;
powerRBV_Vb_b1=(-common*Rb2_Vb_b1/pInst->Rb2/pInst->Rb2)*((4.0*pInst->eVb1b2)+5.0)*0.33333333333333333333;
powerRBV_Vb1_b2=(((-common*Rb2_Vb1_b2/pInst->Rb2/pInst->Rb2)*((4.0*pInst->eVb1b2)+5.0))+((common/pInst->Rb2)*(4.0*eVb1b2_Vb1_b2)))*0.33333333333333333333;
powerRBV_Vc4_c1=(-common*Rb2_Vc4_c1/pInst->Rb2/pInst->Rb2)*((4.0*pInst->eVb1b2)+5.0)*0.33333333333333333333;
powerRBV_Vc3_c1=(-common*Rb2_Vc3_c1/pInst->Rb2/pInst->Rb2)*((4.0*pInst->eVb1b2)+5.0)*0.33333333333333333333;
powerRBV_Vc3_c4=(-common*Rb2_Vc3_c4/pInst->Rb2/pInst->Rb2)*((4.0*pInst->eVb1b2)+5.0)*0.33333333333333333333;
powerRBV_Vb2_e1=(-common*Rb2_Vb2_e1/pInst->Rb2/pInst->Rb2)*((4.0*pInst->eVb1b2)+5.0)*0.33333333333333333333;
powerRBV_Vb2_c2=(-common*Rb2_Vb2_c2/pInst->Rb2/pInst->Rb2)*((4.0*pInst->eVb1b2)+5.0)*0.33333333333333333333;
powerRBV_Vb2_c1=(-common*Rb2_Vb2_c1/pInst->Rb2/pInst->Rb2)*((4.0*pInst->eVb1b2)+5.0)*0.33333333333333333333;
powerRBV_Vc1_c2=(-common*Rb2_Vc1_c2/pInst->Rb2/pInst->Rb2)*((4.0*pInst->eVb1b2)+5.0)*0.33333333333333333333;
#endif
powerRBV=(((common/pInst->Rb2)*((4.0*pInst->eVb1b2)+5.0))*0.33333333333333333333);
EXIT_IF_ISNAN((((common/pInst->Rb2)*((4.0*pInst->eVb1b2)+5.0))*0.33333333333333333333))
#if defined(_DERIVATE) /* probe=V(dt,GND)V(b2,e1)V(b2,c2)V(b2,c1)V(c1,c2) ddxprobe= */
...
double m00_fabs(d00_fabs2,pInst->Izteb)
#if defined(_DERIVATE)
double m10_fabs(d10_fabs0,d00_fabs0,pInst->Ib1)
double m10_fabs(d10_fabs1,d00_fabs1,pInst->Ib2)
double m10_fabs(d10_fabs2,d00_fabs2,pInst->Izteb)
#endif
#if defined(_DERIVATE) /* probe=V(b2,c2)V(b2,c1)V(c1,c2)V(dt,GND)V(b2,e1) ddxprobe= */
powerFBCS_Vb2_c2=((2.0*1.6021918e-19)*(Ib1_Vb2_c2*d10_fabs0+Izteb_Vb2_c2*d10_fabs2));
powerFBCS_Vb2_c1=((2.0*1.6021918e-19)*(Ib1_Vb2_c1*d10_fabs0+Izteb_Vb2_c1*d10_fabs2));
powerFBCS_Vc1_c2=((2.0*1.6021918e-19)*(Ib1_Vc1_c2*d10_fabs0+Izteb_Vc1_c2*d10_fabs2));
powerFBCS_Vdt_GND=((2.0*1.6021918e-19)*((Ib1_Vdt_GND*d10_fabs0+Ib2_Vdt_GND*d10_fabs1)+Izteb_Vdt_GND*d10_fabs2));
powerFBCS_Vb2_e1=((2.0*1.6021918e-19)*((Ib1_Vb2_e1*d10_fabs0+Ib2_Vb2_e1*d10_fabs1)+Izteb_Vb2_e1*d10_fabs2));
#endif
powerFBCS=((2.0*1.6021918e-19)*((d00_fabs0+d00_fabs1)+d00_fabs2));
EXIT_IF_ISNAN(((2.0*1.6021918e-19)*((d00_fabs0+d00_fabs1)+d00_fabs2)))
}
{
double m00_fabs(d00_fabs0,pInst->Ib1)
