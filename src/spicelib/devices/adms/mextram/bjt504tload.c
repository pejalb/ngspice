...
static void bjt504tdebug (CKTcircuit *ckt, bjt504tmodel *model, bjt504tinstance *here)
{
  ...
  fprintf(stdout,"Parameter: model: IZEB=%e\n",model->IZEB);
  fprintf(stdout,"Parameter: model: NZEB=%e\n",model->NZEB);
  ...
  fprintf(stdout,"Parameter: model: VGZEB=%e\n",model->VGZEB);
  fprintf(stdout,"Parameter: model: AVGEB=%e\n",model->AVGEB);
  fprintf(stdout,"Parameter: model: TVGEB=%e\n",model->TVGEB);
  ...
  fprintf(stdout,"Parameter: model: ICSS=%e\n",model->ICSS);
  ...
  fprintf(stdout,"Parameter: model: ASUB=%e\n",model->ASUB);
  ...
  fprintf(stdout,"Parameter: model: GMIN=%e\n",model->GMIN);
}
...
int bjt504tload(GENmodel *inModel, CKTcircuit *ckt)
